...
// #cgo LDFLAGS: -lstdc++ -L/usr/local/cuda/lib64 -L/usr/local/cuda -lcublas -lcudnn -L/home/as29/my_pytorch_cpp/libtorch/lib -ltorch -lcaffe2_gpu -lcaffe2 -lc10 -lcudart -lnvrtc-builtins -lnvrtc -lnvToolsExt -lgomp
import "C"
